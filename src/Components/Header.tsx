...
const Header = ({setSidemenustate}:any) => {
  return (
    <header id="masthead" className="site-header overlap-header" data-sticky-status="scroll-up-enable">
			{/* <link rel="stylesheet" id="elementor-post-182-css" href="./assets/css/post-182.css" type="text/css"
				media="all" /> */}
			<div data-elementor-type="wp-post" data-elementor-id="182" className="elementor elementor-182">
											...
											<div className="elementor-widget-wrap">
												<div className="elementor-element elementor-element-1e2a7daa elementor-widget__width-auto elementor-widget elementor-widget-cs_menu_toggle"
													...
													<div className="elementor-widget-container">
														<button className="menu-toggle elementor-widget-menu-toggle" onClick={() => setSidemenustate('show')}>
												...
												<div className="elementor-element elementor-element-2d1c712b elementor-widget__width-auto elementor-widget elementor-widget-cs_button"
													...
													<div className="elementor-widget-container">
														<link rel="stylesheet" id="elementor-post-1132-css"
															href="./assets/css/post-1132.css" type="text/css"
															media="all" />
														<div className="cs-button-popup cs-popup hide cs-popup-box cs-button-popup-2d1c712b"
																		...
																		<div className="elementor-section-wrap">
																			<section
																				...
																				<div
																					...
																					<div className="elementor-row">
																						<div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-8e06084"
																							data-id="8e06084"
																							...
																							<div
																								...
																								<div
																									...
																									<div className="elementor-element elementor-element-daf9957 elementor-widget elementor-widget-spacer"
																										data-id="daf9957"
																						...
																						<div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-3f50bc0 light-color"
																							data-id="3f50bc0"
																							data-element_type="column"
																							data-settings="{'background_background':'classNameic'}">
																							<div
																								...
																								<div
																									className="elementor-widget-wrap">
																									<div className="elementor-element elementor-element-b798e3f elementor-widget elementor-widget-cs_title"
																										data-id="b798e3f"
																										data-element_type="widget"
																									...
																									<div className="elementor-element elementor-element-3b4c453 elementor-widget elementor-widget-cs_reservation"
																										data-id="3b4c453"
																										data-element_type="widget"
																										...
																										<div
																											...
																											<div
																												...
																												<form
																													...
																													<div
																														className="cs-form-field cs-rooms cs-has-dropdown">
																														<div
																															className="">
																															<label
																																className="cs-form-label">Subject</label>
																															<div
																																className="">
																																<input
																																	type="text"
																											...
																											<div
																												className="daterangepicker ltr auto-apply show-calendar opensright">
																												<div
																													className="ranges">
																												</div>
																												<div
																													className="drp-calendar left">
																													<div
